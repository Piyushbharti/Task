            ...
            <Form form={form} onFinish={handleSubmit} layout="vertical">
                <div className="mainContainer">
                    <div className="container">
                        ...
                        <div className="first">
                            <Form.Item name="ProjectName" label="Project Name" rules={[
                                {
                                    required: true,
                                },
                            ]}>
                        ...
                        <div className="second">
                            <Form.Item name="ProjectType" label="Project Type" rules={[{ required: true }]}>
                                <Select className="input-tag" options={[{ value: 'option 1', label: "option 1" }, { value: 'option 2', label: "option 2" }]} style={{ width: 285 }} placeholder="Please select" />
                            </Form.Item>
                        ...
                        <div className="third">
                            ...
                            <Form.Item name="ProjectManager" label="Project Manager">
                                <Select className="input-tag" options={[{ value: 'Manager 1', label: "Manager 1" }, { value: 'Manager 2', label: "Manager 2" }]} style={{ width: 285 }} placeholder="Please select" />
                            </Form.Item>
                        </div>
                        <div className="four">
                            <Form.Item name="PropertyDesc" label="Property Description">
                                <TextArea placeholder="Property Description" className="Property-Description" autoSize={{ minRows: 4, maxRows: 5 }} />
                            </Form.Item>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <Form.Item name="devices" valuePropName="checked" >
                                <Checkbox.Group className="devices">
                                    <Checkbox className="check" value="Mobile">Mobile</Checkbox>
                                    <Checkbox className="check" value="Tablet">Tablet</Checkbox>
                                    <Checkbox className="check" value="Desktop">Desktop</Checkbox>
                                </Checkbox.Group>
                            </Form.Item>
                            {/* </div> */}
                        </div>
                        <div>
                            ...
                            <Form.Item name="filterOptions" valuePropName="checked">
                                <Checkbox.Group className="filter">
                                    <Checkbox className="check" value="gatesurvey">Gatesurvey</Checkbox>
                                    <Checkbox className="check" value="fraud_detection">fraud_detection</Checkbox>
                                </Checkbox.Group>
                            </Form.Item>
                            {/* </div> */}
                        </div>
                ...
                <div>
                <h4 className="header-text">SPECIFICATIONS</h4>
                <Table pagination={false} dataSource={data} columns={columns} />
                </div>
                <div className="Button">
                <Button type="primary" htmlType="submit" style={{ marginTop: "16px", background: "red"}}>
                    Cancel
                </Button>
                <Button type="primary" htmlType="submit" style={{ marginTop: "16px",  marginLeft: "2px" }}>
                    Submit
                </Button>
                </div>
            </Form>
